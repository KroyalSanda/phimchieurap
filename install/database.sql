...
CREATE TABLE IF NOT EXISTS `ads` (
  ...
  `ads_name` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unique_name` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ads_size` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ads_type` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ads_url` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `ads_image_url` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ads_code` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `calendar` (
  ...
  `coordinates` char(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `timezone` char(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `comments` varchar(85) COLLATE utf8mb4_unicode_ci NOT NULL,
  `utc_offset` char(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `utc_dst_offset` char(8) COLLATE utf8mb4_unicode_ci NOT NULL,
  `notes` varchar(79) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cron` (
  ...
  `save_to` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `videos_id` int(250) DEFAULT NULL,
  `admin_email_from` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_email` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_to` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_sub` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `download_link` (
  ...
  `link_title` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `episodes` (
  ...
  `stream_key` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `videos_id` int(11) DEFAULT NULL,
  `seasons_id` int(11) DEFAULT NULL,
  `episodes_name` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_source` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `source_type` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `keys` (
  ...
  `label` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT 'System',
...
CREATE TABLE IF NOT EXISTS `language_list` (
  ...
  `text_direction` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` int(11) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `live_tv` (
  ...
  `tv_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `stream_from` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stream_label` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `stream_url` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `poster` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `focus_keyword` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `live_tv_category` (
  ...
  `live_tv_category` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `live_tv_category_desc` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `live_tv_url` (
  ...
  `url_for` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `page` (
  ...
  `page_title` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seo_title` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `focus_keyword` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `plan` (
  ...
  `screens` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `post_title` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seo_title` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `focus_keyword` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_description` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `content` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image_link` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `post_category` (
  ...
  `category_desc` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `quality` (
  ...
  `quality` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `seasons` (
  ...
  `videos_id` int(11) DEFAULT NULL,
  `seasons_name` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order` int(50) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `slider` (
  ...
  `action_type` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `action_btn_text` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `action_id` int(50) DEFAULT NULL,
  `action_url` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order` int(50) NOT NULL DEFAULT 0,
  `publication` int(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `star` (
  ...
  `star_type` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `star_name` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `star_desc` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT 1,
  PRIMARY KEY (`star_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `subscription` (
  ...
  `transaction_id` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `subtitle` (
  ...
  `kind` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `src` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `srclang` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tvseries_subtitle` (
  ...
  `videos_id` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `theme_color` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '#16163F',
  `join_date` datetime DEFAULT NULL,
  `last_login` datetime DEFAULT NULL,
  `phone` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dob` date DEFAULT '0000-00-00',
  `firebase_auth_uid` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `videos` (
  ...
  `release` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `video_file` (
  ...
  `source_type` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `label` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Server#1',
  `order` int(50) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `video_type` (
  ...
  `video_type` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_type_desc` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `wish_list` (
  ...
  `wish_list_type` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL,
